class Flowchart {
  ...
  addNode(text, positionHint = { x: 0, y: 0 }, shapeType = 'rectangle') {
    ...
    try {
      ...
      const node = new FlowchartNode(nodeId, validatedText, validatedPosition.x, validatedPosition.y, 1, 0.5, validatedShapeType);
